...
@org.springframework.web.bind.annotation.RequestMapping(method=org.springframework.web.bind.annotation.RequestMethod.GET, value="/coconutservice") public  main.groovy.application.coconut.Coconut getCoconut(@org.springframework.web.bind.annotation.RequestParam(value="id") java.lang.String id) { return (main.groovy.application.coconut.Coconut)null;}
}
